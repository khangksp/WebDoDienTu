...
function Navbar() {
    ...
    const [registerData, setRegisterData] = useState({
        ...
        password: "",
        confirmPassword: "",
        loaiquyen: "khach", // Mặc định là khach
        tennguoidung: "",
        email: "",
        sodienthoai: "",
    });
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            setErrorMessage(
                t("dangNhapThatBai") + ": " +
                (error.response?.data?.message || t("loiKhongXacDinh"))
            );
        }
    };
    ...
    const handleRegister = async (e) => {
      e.preventDefault();
      const { tendangnhap, password, confirmPassword, loaiquyen, tennguoidung, email, sodienthoai } = registerData;
      ...
      try {
          ...
          console.error("Register error:", error); // Log lỗi đầy đủ
          console.log("Response data:", error.response?.data); // Log dữ liệu phản hồi
                        ...
                        <div className="login-modal-body">
                            <form onSubmit={handleRegister}>
                                {[
                                    ...
                                    { icon: faLock, placeholder: t("xacNhanMatKhau"), field: "confirmPassword", type: "password" },
                                ].map((input) => (
                ...
                <div className="login-modal-overlay">
                    <div className="login-modal modal-animation" ref={modalRefs.verification}>
                        <div className="login-modal-header">
                            ...
                            <p>{t("soDienThoaiDaCoTaiKhoan")} {registerData.sodienthoai}</p>
                            <button className="close-button" onClick={resetModals}>
                                <FontAwesomeIcon icon={faTimes} />
                            </button>
                        </div>
